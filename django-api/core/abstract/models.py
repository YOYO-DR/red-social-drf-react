...
class AbstractModel(models.Model): # AbstractModel: es una clase abstracta que hereda de models.Model, y se utiliza para definir campos comunes a todos los modelos, como public_id, created y updated
