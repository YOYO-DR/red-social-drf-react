...
class RegisterViewSet(ViewSet):
  ...
  def create(self, request, *args, **kwargs):
    serializer = self.serializer_class(data=request.data) # creo una instancia del serializer con los datos de la request
    ...
    return Response({ # devuelvo el usuario, el token de refresco y el token de acceso
